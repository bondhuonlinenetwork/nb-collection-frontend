...
import './table.css';
import { getRowActions, fetchedData, tableHeaders, inputFieldsConfig, enableRowSelection, defaultSort, formatDate } from './table-config';
...
function Table({ ...rest }) {
    ...
    const [sortConfig, setSortConfig] = useState({ key: defaultSort.key, direction: defaultSort.direction });
